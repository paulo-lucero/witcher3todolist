...
//cutoff
contsM.addContUpdater(function(rlts) {
    ...
    for (let rlt of rlts) {
      ...
      for (let cutoffCont of cutoffConts) {
        let cutOffData = genQueryData(rlt, document.createElement('li'), 5);
...
contsM.addContUpdater(function(rlts) {
    ...
    if (infoData.includes('level')) {
      ...
      for (let rlt of rlts) {
        ...
        let crucData = genQueryData(rlt, document.createElement('div'), 5);
